...
#
# Generated by Vivado on Wed Dec 25 15:32:44 +0800 2019
...
# Script info
echo -e "dds_compiler_1.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/c_2019/dds_test/DDS/DDS.cache/compile_simlib/modelsim"
  fi
